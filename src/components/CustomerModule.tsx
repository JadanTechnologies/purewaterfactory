...
export default function CustomerModule({
  ...
  const canWrite = activeRole === 'Administrator' || activeRole === 'Super Admin' || activeRole === 'Factory Manager' || activeRole === 'Sales Officer' || activeRole === 'Cashier' || activeRole === 'Sales & Cashier Officer';
